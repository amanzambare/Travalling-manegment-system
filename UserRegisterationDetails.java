...
public class UserRegisterationDetails extends JFrame implements ActionListener
{
    ...
    UserRegisterationDetails()
	{
	     ...
	     */   
	        model = new DefaultTableModel(new Object[]{"Name","Gender","Address","Mobile","Email","Username","Password"},0);
	...
	private static void insertData() {
		...
		try{
			...
			ResultSet rs=((java.sql.Statement) stmt).executeQuery("select * from tbl_project");
			...
			while(rs.next())
				...
				stringRooms =  rs.getString(7);
				 ...
				 model.addRow(new Object[]{stringOwnerName,stringOccpancy,stringAddress,stringMobileNumber,stringEmail_id,stringCity,stringRooms});				}
